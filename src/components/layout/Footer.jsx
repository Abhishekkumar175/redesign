...
const CONTACT = [
  {
    icon: Mail,
    label: "contact@emounting.in",
    href: "mailto:contact@emounting.in",
  },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <Link
              ...
              aria-label="eMounting Solutions – Home"
            >
              <svg
                width="40"
                height="40"
              ...
              >
                ...
                <polyline
                  points="9,31 18,17 22,23 27,15 35,31"
                  stroke="#F1592A"
                  strokeWidth="2.5"
                ...
                />
                <path
                  d="M12 22 Q12 14 22 14 Q32 14 32 22 Q32 24 28 24 H14"
                  stroke="white"
                  strokeWidth="2.2"
                  fill="none"
                  strokeLinecap="round"
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[9px] text-white/50 font-inter tracking-wide uppercase">
                  Solutions
                </span>
              </div>
            </Link>
            ...
            <p className="text-[14px] text-white/70 leading-relaxed mb-6">
              A leading software development and IT consultancy firm delivering
              innovative, technology-driven solutions across industries.
            </p>

            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/company/emounting-solutions-private-limited/"
              target="_blank"
              ...
              {CONTACT.map(({ icon: Icon, label, href }) => (
                <li key={label} className="flex items-start gap-3">
                  ...
                  {href ? (
                    <a
                      href={href}
                      className="text-white/70 hover:text-accent text-[13px] leading-relaxed transition-colors"
                    >
                      {label}
                    </a>
                  ) : (
